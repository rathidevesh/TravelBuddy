...
export default function Suv(props) {
  ...
  const onchange = (e)=>{
   ...
   const filteredSUVs = notes
    .filter((note) => note.cartype === "SUV")
    .filter((note) =>
  ...
  return (
    ...
    <div className="row my-3">
      ...
      <div className="col-md-4 mx-auto my-3 position-relative">
  <i
  ...
  <input
    ...
    placeholder="Search SUV by name..."
    value={search}
